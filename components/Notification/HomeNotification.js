...
export default class HomeNotificaton extends React.Component {
  render() {
    return (
        ...
        <View style={CSS.chiaflex1}>
          ...
          <View style={CSS.chiaflexlay2phan}>
            <View style={CSS.flex}>
              ...
              <Text style={CSS.textnetword12}>13/02/2019</Text>
              <Text numberOfLines={2} style={CSS.titlehuyen1}>
                Giảm ngay 300k khi mua ĐH trên 1,500 triệu. Số lượng cực kỳ có
                hạndddddddddddddddddddddddfffffffffffffffffffffffffffffffffffffffffffffffffffffff
              </Text>
            </View>
